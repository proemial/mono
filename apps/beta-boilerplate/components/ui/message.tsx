...
const messageVariants = cva(
    "flex flex-col place-items-end md:max-w-prose",
    {
        variants: {
            variant: {
                question: "w-fit",
...
const messageContentVariants = cva(
    "flex items-center text-base pl-4"
)

const messageBubbleVariants = cva(
    "bg-card rounded-2xl px-4 pt-2 pb-3"
)

const messageActionVariants = cva(
    "flex flex-col items-center text-2xs pl-3"
)
...
const messageAuthorVariants = cva(
    "flex gap-2 items-center"
)

const messageRepliesVariants = cva(
...
const MessageReplies = React.forwardRef<
    HTMLDivElement,
    MessageRepliesProps
>(({ className, ...props }, ref) => (
    <div
...
export { Message, MessageContent, MessageBubble, MessageAction, MessageFooter, MessageAuthor, MessageReplies }