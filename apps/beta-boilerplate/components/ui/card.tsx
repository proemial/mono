...
const cardDescriptionVariants = cva(
  "text-2xs text-foreground uppercase",
  {
    variants: {
      variant: {
        default: "",
        ...
        paperCoAuthor: "text-2xs mx-auto text-foreground uppercase text-wrap text-center whitespace-normal"
      },
    },
    defaultVariants: {
      variant: "default",
...
const cardBulletVariants = cva(
  "",
  {
    variants: {
      variant: {
        default: "",
        numbered: "rounded-full w-[17px] h-[17px] border border-foreground text-2xs pt-px items-center text-center"
      },
    },
    defaultVariants: {
      variant: "default",
...
const CardBullet = React.forwardRef<
  HTMLDivElement,
  CardBulletProps
>(({ className, variant, ...props }, ref) => (
  <div
...
export { Card, CardHeader, CardFooter, CardTitle, CardDescription, CardContent, CardBullet }
