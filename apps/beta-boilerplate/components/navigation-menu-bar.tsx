        ...
        <NavigationMenu>
            <NavigationMenuList>
                ...
                <NavigationMenuItem className="flex-none px-1" key="create">
                    ...
                    {pathname === "/ask" && <Link href="#" legacyBehavior passHref><ButtonEdit handleClick={handleClick} /></Link>}
                    {pathname !== "/ask" && <Link href="#" legacyBehavior passHref><ButtonCompass handleClick={handleClick} /></Link>}
