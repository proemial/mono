		...
		messages: [
			{
				role: "user",
				content: `
You are given a news article and the abstracts of 5 scientific research papers:
...
<task_1>
Exclusively using topics and discoveries from the 5 abstracts, list 5 scientific facts that relate to the key topics discussed in the news article.
