			...
			<div className="flex items-center gap-2 pt-1 pb-0 px-3 relative self-stretch w-full flex-[0_0_auto]">
				<div className="flex items-center gap-3 relative flex-1 grow">
					<div className="inline-flex items-center gap-2 relative flex-[0_0_auto]">
						...
						<div className="relative w-fit [font-family:'Lato-Regular',Helvetica] font-normal text-[13px] tracking-[0] leading-[normal]">
							101
						</div>
					</div>
					...
					<div className="inline-flex items-center gap-1 px-3 py-2 relative flex-[0_0_auto] rounded-[19px] border border-solid border-[#d0d2da]">
						<div className="relative w-fit mt-[-1.00px] [font-family:'Lato-Regular',Helvetica] font-normal text-[13px] tracking-[0] leading-[normal]">
							Ask question
						</div>
					</div>
				</div>
