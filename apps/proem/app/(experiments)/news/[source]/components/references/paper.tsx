...
export function Paper({ paper }: { paper?: ReferencedPaper }) {
	...
	return (
		<div className="flex flex-col items-start gap-[3px] relative flex-1 grow">
			...
			<p className="relative self-stretch font-normal text-[#757989] text-xs tracking-[0] leading-[normal] overflow-hidden text-ellipsis  [display:-webkit-box] [-webkit-line-clamp:1] [-webkit-box-orient:vertical]">
