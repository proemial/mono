...
The facts must be short, fascinating and presented using layman's terminology, in a way that makes the reader curious to learn more. It's imperative that you include numerical references to the abstracts when quoting text or sources, using brackets: [#].
</task_1>
