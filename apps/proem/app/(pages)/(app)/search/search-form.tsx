			...
			<div className="flex items-center w-full border text-foreground bg-card border-background rounded-3xl">
				<div className="flex items-center w-full border text-foreground bg-card border-background rounded-3xl">
					<input
						...
						className="w-full h-12 pl-6 resize-none flex items-center text-lg bg-card placeholder:opacity-40 placeholder:text-foreground rounded-l-3xl outline-none"
