...
import { Feedback } from "@/old/(pages)/(app)/profile/components/feedback";
import { Privacy } from "@/old/(pages)/(app)/profile/components/privacy";
import { ProfileButtons } from "@/old/(pages)/(app)/profile/components/profile-buttons";
