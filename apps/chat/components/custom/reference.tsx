...
export function Reference({
	...
	return (
		...
		>
			...
			>
				<div className="p-2 relative flex flex-row justify-between items-center w-full after:content-[''] after:absolute after:left-0 after:right-0 after:h-4 after:bg-gradient-to-b after:from-background dark:after:from-muted after:to-transperant after:top-12 after:pointer-events-none">
					<div className="flex flex-row gap-3 items-start w-full">
						...
						<div className="text-base md:text-xl h-[34px] flex items-center text-muted-foreground truncate leading-4">
