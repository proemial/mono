"use client";
// Modified with CarouselDots which was not part of the original shadcn-ui carousel, plus CarouselPrevious/CarouselNext children, to allow formatted arrows
...
>(
	(
		...
		const hidden = currentSlide === numberOfSlides - 1;
		...
		return (
			<>
				{!hidden && (
					<div
						ref={ref}
						className={`absolute bottom-8 md:bottom-12 w-full flex justify-center ${props.className}`}
					>
